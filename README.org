...
This will build the proper database functions as well as add some dummy development data to the website.
...
will be displayed in the browser and JavaScript source files will be
