...
PGPASSWORD=ceo psql -U ceo --host=localhost -p5432 -d ceo -a -f update_2019_05_20.sql --echo-errors
PGPASSWORD=ceo psql -U ceo --host=localhost -p5432 -d ceo -a -f update_2019_06_02.sql --echo-errors
