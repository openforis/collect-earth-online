...
function renderPage(page,args) {
    switch(page){
        case "home":renderHome(args);
                    break;
        case "collection":renderCollection(args);
            break;
        case "institution":renderInstitution(args);
            break;
        case "project":renderProject(args);
            break;
        case "account-page":renderAccount(args);
            break;
    }
}