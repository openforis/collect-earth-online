...
function SurveyQuestion(props) {
    ...
    <p><i>Note: Answer(s) type : {(props.surveyQuestion.componentType ? props.surveyQuestion.componentType : "button") + "-" + (props.surveyQuestion.dataType ? props.surveyQuestion.dataType : "text")}</i></p>
