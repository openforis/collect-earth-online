            ...
            <div className="container-fluid">
                ...
                <div className="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1 justify-content-center">
                    ...
                    >
                        ...
                        <ol>
                            {this.getLi(this.state.LngObject.click_add_widget)}
                            {this.getLi(this.state.LngObject.select_image_collection)}
                                ...
                                <ol style={{ listStyleType: "lower-alpha" }}>
                                    ...
                                    <li>
                                        ...
                                        <ol style={{ listStyleType: "lower-roman" }}>
                                            ...
                                            {this.getLi("Sentinel 2 - B1, B2, B3, B4, B5, B6, B7, B8, B8a, B9, B10, B11, B12")}
                                        </ol>
                                    </li>
                                    <li>
                                        <span data-tag="custom_widget_info"></span>
                                        <ol style={{ listStyleType: "lower-roman" }}>
                                            {this.getLi(" Offline Carbon Monoxide - COPERNICUS/S5P/OFFL/L3_CO\n" +
                            ...
                            {this.getLi(this.state.LngObject.select_date_range)}
                    ...
                    >
                        ...
                        <ol>
                            {this.getLi(this.state.LngObject.click_add_widget)}
                            {this.getLi(this.state.LngObject.select_stats)}
                    ...
                    >
                        ...
                        <ol>
                            {this.getLi(this.state.LngObject.click_add_widget)}
                            {this.getLi(this.state.LngObject.select_dual_image_collection)}
                            {this.getLi(this.state.LngObject.choose_basemap)}
                            <li>
                                ...
                                <ol style={{ listStyleType: "lower-alpha" }}>
                                    ...
                                    <li>
                                        ...
                                        <ol style={{ listStyleType: "lower-alpha" }}>
                                            ...
                                            {this.getLi(this.state.LngObject.skip_date)}
                                        </ol>
                                    </li>
                                    <li>
                    ...
                    >
                        ...
                        <br className="previewbreak"/>
                        <ol>
                            {this.getLi(this.state.LngObject.drag_drop)}
                            {this.getLi(this.state.LngObject.resize_by)}
