...
<div id="about">
    ...
    require land cover and/or land use reference data. Mapcha promotes
    consistency in locating, interpreting, and labeling reference data
    plots for use in classifying and monitoring land cover / land use
