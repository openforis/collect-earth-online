...
<div id="collection" class="row" ng-app="collection" ng-controller="CollectionController as collection"
    ...
    <div id="sidebar" class="col-xl-3" old_ng-show="collection.showSideBar">
        ...
        <fieldset ng-repeat="sampleValueGroup in collection.currentProject.sampleValues" class="mb-1 justify-content-center text-center">
    ...
    margin-top: 4px;"></div>
        ...
        <div class="row">
			<div class="col-sm-12 btn-block">
           			<button id="save-values-button" class="btn btn-outline-lightgreen btn-sm btn-block" type="button" name="save-values" ng-click="collection.saveValues()"
	                   style="opacity:0.5" disabled>Save</button>
	...
	<!-- project stats button -->			
    		...
    		<!-- end project stats button -->
        			<button id="collection-quit-button" class="btn btn-outline-danger btn-block btn-sm" type="button" name="collection-quit" ng-class="collection.quitclass" data-toggle="modal" data-target="#confirmation-quit">
        				Quit
        			</button>        
