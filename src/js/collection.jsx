...
class Collection extends React.Component {
  ...
  componentDidMount() {
    console.log("collection mounted!", this.props, this.state);
    ...
    return (
      <div className="row" style={{ height: "-webkit-fill-available" }}>
        ...
        {(!this.props.acceptedTerms && (this.state.currentProject?.type === 'simplified')) && (
          <AcceptTermsModal currentUser={this.state.currentUserId} projectId={this.props.projectId} toggleAcceptTermsModal={this.toggleAcceptTermsModal} />
        )}
