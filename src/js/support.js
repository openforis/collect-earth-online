                ...
                <div className="col-xl-7 col-lg-10">
                    ...
                    <div className="btn-group-vertical btn-block mb-4">
                        ...
                        <a
                            ...
                            role="button"
                        >
                            &#x1F4BE; Manual de Creación de Instituciones y Proyectos (para el
                            Administrador)
                        </a>
                        <a
                            className="btn btn-outline-lightgreen btn-block"
                            ...
                            role="button"
                        >
                            &#x1F4BE; Manuel de création de projets et de profils d’institution
                        ...
                        <a
                            ...
                            role="button"
                        >
                            &#x1F4BE; Manual de Criação de Instituições e Projetos (para
                            Administrador)
                        </a>
                    </div>
                    <div className="btn-group-vertical btn-block mb-4">
                    ...
                    <p className="text-center col-lg-10 offset-lg-1 mb-4">
                        This content is currently under development. Please check back later for
                        updates.
                    </p>
                    ...
                    <p className="text-center col-lg-10 offset-lg-1 mb-4">
                        Please access{" "}
                        <a href="http://www.openforis.org/support" target="_blank" rel="noreferrer">
                            OpenForis Support
                        </a>{" "}
                        for further support.
                    </p>
                    ...
                    <p className="text-center col-lg-10 offset-lg-1 mb-4">
                        Please access the{" "}
                        <a href="/geo-dash/geo-dash-help" target="_blank" rel="noreferrer">
                            Geo-Dash Help Center
                        </a>{" "}
