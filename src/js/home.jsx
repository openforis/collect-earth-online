...
function Highlights ({userId, userRole}) {
  const [appState, setAppState] = useAtom(stateAtom);  
...
export function pageInit(params, session) {
  ReactDOM.render(
    <NavigationBar userId={session.userId} userName={session.userName} version={session.versionDeployed}>      <Highlights userId={session.userId} userRole={session.userRole}/>
