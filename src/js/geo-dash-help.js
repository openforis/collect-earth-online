                ...
                <div className="container-fluid" style={{overflowWrap: "break-word"}}>
                    <div className="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1 justify-content-center">
                        ...
                        <CollapsibleSectionBlock title={lngObject.head_image_collection_widget}>
                            {this.expandableImageWrapper(
                                "/img/geodash/image_collection_widget.gif"
                            )}
                            <ol>
                                    ...
                                    <ol style={{listStyleType: "lower-alpha"}}>
                                        ...
                                        <li>
                                            ...
                                            <ol style={{listStyleType: "lower-roman"}}>
                                                <li>
                                                    {
                                                        "Landsat 5 - B1, B2, B3, B4, B5, B6, B7 - Sample parameters: bands: 'B4,B5,B3', min: '0.05,0.01,0.07', max: '0.45,0.5,0.4', cloudLessThan: 90"
                                                    }
                                                </li>
                                                <li>
                                                    {
                                                        "Landsat 7 - B1, B2, B3, B4, B5, B6_VCID_1, B6_VCID_2, B7, B8 - Sample parameters: bands: 'B4,B5,B3', min: '0.03,0.01,0.05', max: '0.45,0.5,0.4', cloudLessThan: 90"
                                                    }
                                                </li>
                                                <li>
                                                    {
                                                        "Landsat 8 - B1, B2, B3, B4, B5, B6, B7, B8, B9, B10, B11 - Sample parameters: bands: 'B5,B6,B4', min: '0.03,0.01,0.04', max: '0.45,0.5,0.32', cloudLessThan: 90"
                                                    }
                                                </li>
                                                <li>
                                                    {
                                                        "Sentinel 2 - B1, B2, B3, B4, B5, B6, B7, B8, B8a, B9, B10, B11, B12 - Sample parameters: bands: 'B8,B4,B3', min: '900,450,800', max: '5200,3000,2000', cloudLessThan: 10"
                                                    }
                                                </li>
                                            </ol>
                                        </li>
                        ...
                        <CollapsibleSectionBlock title={lngObject.add_time_series_graph}>
                            {this.expandableImageWrapper(
                                "/img/geodash/time_series_graph_widget.gif"
                            )}
                            <ol>
                                <li>{lngObject.click_add_widget}</li>
                        ...
                        <CollapsibleSectionBlock title={lngObject.add_dual_image_collection}>
                            {this.expandableImageWrapper(
                                "/img/geodash/dual_image_collection_widget.gif"
                            )}
                            <ol>
                                <li>{lngObject.click_add_widget}</li>
                                    ...
                                    <ol style={{listStyleType: "lower-alpha"}}>
                                        ...
                                        <li>
                                            ...
                                            <ol style={{listStyleType: "lower-alpha"}}>
                                                <li>{lngObject.give_title}</li>
                                                <li>
                                                    {lngObject.enter_image_asset +
                                                        "users/ValeriaContessa/Indonesia_2000"}
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <ol style={{listStyleType: "lower-roman"}}>
                                                <li>
                                                    {
                                                        'Offline Carbon Monoxide - COPERNICUS/S5P/OFFL/L3_CO {"bands":"CO_column_number_density,H2O_column_number_density,cloud_height","min":"0","max":"0.5"} \n 2018-01-01 to 2018-12-31'
                                                    }
                                                </li>
                                                <li>{lngObject.custom_widget_warning}</li>
                                            </ol>
                        ...
                        <CollapsibleSectionBlock title={lngObject.add_image_asset}>
                            ...
                            <ol>
                                ...
                                <li>
                                    {lngObject.enter_image_asset +
                                        " users/billyz313/carbon_monoxide"}
                                </li>
                                <li>
                                    {lngObject.enter_image_asset_params}
                                    {
                        ...
                        <CollapsibleSectionBlock title={lngObject.add_image_collection_widget}>
                            {this.expandableImageWrapper(
                                "/img/geodash/image_collection_asset_widget.gif"
                            )}
                            <ol>
                                <li>{lngObject.click_add_widget}</li>
                                ...
                                <li>{lngObject.give_title}</li>
                                <li>
                                    {lngObject.enter_image_collection_asset +
                                        "users/ValeriaContessa/Indonesia_2000"}
                                </li>
                                <li>
                                    {lngObject.enter_image_asset_params +
                        ...
                        <CollapsibleSectionBlock title={lngObject.add_degradation_widget}>
                            {this.expandableImageWrapper(
                                "/img/geodash/create_degradation_widget.gif"
                            )}
                            <ol>
                        ...
                        <CollapsibleSectionBlock
                            title={lngObject.gee_imageCollection_asset_creation}
                        >
                            <iframe
                                style={{width: "100%", height: "570px"}}
