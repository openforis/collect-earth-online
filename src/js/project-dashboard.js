...
class ProjectDashboard extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (
            Object.entries(prevState.projectDetails).length === 0 &&
        ...
        if (
            ...
            this.setState({
                projectDetails: {
                    ...
                    baseMapSource:
                        this.state.projectDetails.baseMapSource || this.state.imageryList[0].title,
                },
                isMapShown: true,
            });
            this.showProjectMap();
                ...
                <div className="mb-4">
                    ...
                    <div className="container row pl-4">
                        ...
                        <div className="pr-4">
                            ...
                            <span className="badge badge-pill bg-lightgreen ml-3">
                                {publishedDate ||
                                    (availability === "unpublished" ? "Unpublished" : "Unknown")}
                            </span>
                        </div>
                        <div className="pr-4">
                            Date Closed
...
export function pageInit(args) {
    ReactDOM.render(
        <NavigationBar userName={args.userName} userId={args.userId}>
            <ProjectDashboard projectId={args.projectId || "0"} />
        </NavigationBar>,
