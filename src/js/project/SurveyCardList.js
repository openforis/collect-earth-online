...
class SurveyCard extends React.Component {
    ...
    swapQuestionIds = (upOrDown) => {
        ...
        this.props.setProjectDetails({
            surveyQuestions: this.props.surveyQuestions.map((sq) => ({
                ...sq,
                        ...
                        {inDesignMode && (
                            <div className="col-2 d-flex pr-1 justify-content-end">
                                <button
                                    ...
                                    style={{
                                        opacity:
                                            surveyQuestion.id === topLevelNodeIds[0]
                                                ? "0.25"
                                                : "1.0",
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    disabled={
                                        surveyQuestion.id ===
                                        topLevelNodeIds[topLevelNodeIds.length - 1]
                                    }
                                    style={{
                                        opacity:
                                            surveyQuestion.id ===
                                ...
                                <>
                                    ...
                                    <li>
                                        ...
                                        {surveyQuestion.parentAnswer === -1
                                            ? "Any"
                                            : parentQuestion.answers.find(
                                                  (ans) => ans.id === surveyQuestion.parentAnswer
                                              ).answer}
                                    </li>
                                </>
                            )}
                    ...
                    <div className="SurveyQuestionTree__answers">
                        {surveyQuestion.answers.map((surveyAnswer, uid) => (
                            <ExistingAnswer
                                ...
                                removeAnswer={() =>
                                    inDesignMode && removeAnswer(surveyQuestion.id, surveyAnswer.id)
                                }
                            />
                        ))}
    ...
    return (
        <div className="ExistingAnswer">
            <div className="col d-flex">
                ...
                <div className="ExistingAnswer__answer">{answer}</div>
            </div>
        </div>
    );
}
