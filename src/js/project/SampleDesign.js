    ...
    renderLabeledInput = (label, property) => (
        <div className="form-group">
            ...
            <input
                ...
                onChange={(e) =>
                    this.context.setProjectDetails({[property]: Number(e.target.value)})
                }
            />
        </div>
    );
    ...
    render() {
        ...
        return (
            <div id="sample-design">
                    ...
                    <div className="mb-3">
                        <div className="form-check form-check-inline">
                            <input
                                ...
                                onChange={() =>
                                    setProjectDetails({allowDrawnSamples: !allowDrawnSamples})
                                }
                        ...
                        <p className="font-italic ml-2 small">
                            - Enable this to allow users to draw and label points, linestrings, and
                            polygons during data collection.
                        </p>
                    </div>
                )}
                <div style={{display: "flex"}}>
                ...
                >
                    {samplesPerPlot > 0 &&
                        `Each plot will contain around ${formatNumberWithCommas(
                            samplesPerPlot
                        )} samples.`}
                    ...
                    {totalPlots > 0 &&
                        ...
                        `* The maximum allowed for the selected sample distribution is ${formatNumberWithCommas(
                            ...
                            ` samples per plot. * The maximum allowed samples per project is ${formatNumberWithCommas(
                                sampleLimit
                            )}.`}
                </p>
            </div>
        ...
        <ProjectContext.Consumer>
            {({
                ...
                <div id="sample-review">
                    ...
                    {allowDrawnSamples && (
                        <h3>Users can draw additional samples at collection time.</h3>
                    )}
                </div>
            )}
        </ProjectContext.Consumer>
            ...
            {({plotDistribution, sampleDistribution, plotShape}) => (
                <div className="p-3">
                    {plotDistribution === "shp" ? (
                        ...
                        <div>
                            <h3>
                                The following is a mock up of a {plotShape} plot with{" "}
