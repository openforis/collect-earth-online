  ...
  setQaqcAssignment = (newAssignment) => {
    ...
    this.context.setProjectDetails({
      designSettings: {
        ...
        qaqcAssignment: { ...assignment, ...newAssignment },
      },
    });
  };
    ...
    return (
      <div className="col-6">
        ...
        <div className="ml-3">
          ...
          <p className="font-italic ml-2 mt-2">- SME: Subject Matter Expert</p>
          {allowDrawnSamples ? (
            <p className="font-italic ml-2 mt-2">
              - When User-Drawn samples are enabled, the project cannot support Quality Control of
              plots. Disable User-Drawn samples to re-enable Quality Control.
            </p>
          ) : (
            userMethod === "none" && (
              ...
              <div className="form-row mt-3">
                ...
                <div className="col-5 d-flex align-items-center">
                  <input
                    ...
                    value={percent}
                  />
                  <div style={{ fontSize: "0.9rem", marginLeft: "0.5rem" }}>{percent}%</div>
                </div>
              </div>
              <p className="font-italic ml-2">- Percent of each users plots to review</p>
            </>
          )}
          {qaqcMethod === "overlap" && (
            <>
              <div className="form-row mt-3">
                <label className="col-5" htmlFor="reviews">
                  # of Reviews:
                </label>
                <input
              ...
              <p className="font-italic mt-2 ml-2">
                {`- ${formatNumberWithCommas(
                  plotsToReview
                )} plots will be reviewed ${timesToReview} times.`}
              </p>
            </>
          )}
